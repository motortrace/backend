...
export class LaborService {
  ...
  async createLabor(data: CreateLaborRequest): Promise<WorkOrderLabourWithDetails> {
    ...
    // Create labor record
    const labor = await prisma.workOrderLabour.create({
      data: {
    ...
    return labor as WorkOrderLabourWithDetails;
  }
